...
import { Plus, Search, Filter, Play, Calendar, Clock, User, MapPin, MoreHorizontal, SlidersHorizontal } from 'lucide-react'
...
const MOCK: MemoryItem[] = [
  { id: 1, title: 'The Naming Ceremony', description: 'Grandmother recounts a traditional naming rite in Enugu.', duration: '12:45', uploadedBy: 'Ada Obi', uploadDate: 'Jan 12, 2024', location: 'Enugu, Nigeria', category: 'Ceremony', tags: ['Naming', 'Tradition'] },
  { id: 2, title: 'Market Days', description: 'Uncle Sola talks about the old market square and traders.', duration: '08:21', uploadedBy: 'Sola Ade', uploadDate: 'Dec 29, 2023', location: 'Ibadan, Nigeria', category: 'Daily Life', tags: ['Market', 'Community'] },
  { id: 3, title: 'Migration West', description: 'Father shares the 80s migration journey across states.', duration: '18:03', uploadedBy: 'Chinedu N.', uploadDate: 'Nov 3, 2023', location: 'Lagos, Nigeria', category: 'Migration', tags: ['Journey'] },
]
          ...
          <Card key={m.id} className="hover:shadow-lg transition-shadow">
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 flex items-center gap-2">
                <Link to={`/cultural-memories/${m.id}`} className="flex-1">
