    ...
    try {
      ...
      if (typeof memberData.id === 'string') {
        const firestoreUpdates = {
          ...
          ...(memberData.birthYear && { birthYear: memberData.birthYear }),
          ...(memberData.deathYear && { deathYear: memberData.deathYear }),
          ...(memberData.birthPlace && { birthPlace: memberData.birthPlace }),
          ...(memberData.deathPlace && { deathPlace: memberData.deathPlace }),
          ...(memberData.location && { location: memberData.location }),
          ...(memberData.city && { city: memberData.city }),
          ...(memberData.state && { state: memberData.state }),
          ...(memberData.country && { country: memberData.country }),
          ...(memberData.address && { address: memberData.address }),
          ...(memberData.coordinates && { coordinates: memberData.coordinates }),
          ...(memberData.occupation && { occupation: memberData.occupation }),
