        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-gray-600 hover:text-ancestor-primary font-medium transition-colors duration-200"
            >
              Home
            </button>
            <button
        ...
        {isOpen && (
          <div className="md:hidden border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button
                onClick={() => scrollToSection('home')}
                className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-ancestor-primary hover:bg-gray-50"
              >
                Home
              </button>
              <button
              ...
              <div className="pt-2 space-y-2">
                <Link
                  to="/signup"
                  className="block w-full text-center px-3 py-2 rounded-md text-base font-medium border border-ancestor-primary text-ancestor-primary hover:bg-ancestor-primary/10"
